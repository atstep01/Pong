...
public class PaddleTestTwo extends Canvas implements KeyListener, Runnable
{
	...
	public PaddleTestTwo()
	{
		...
		//instantiate a Ball
		ball = new Ball(200,200,30,30,Color.GREEN,3,3);


		//instantiate a left Paddle
		leftPaddle = new Paddle(100,100,50,150,Color.YELLOW,15);



		//instantiate a right Paddle
		rightPaddle = new Paddle(600,100,50,150,Color.YELLOW,15);
